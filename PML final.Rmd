...
training <- read.csv(url("https://d396qusza40orc.cloudfront.net/predmachlearn/pmltraining.csv"),header=TRUE)
test <- read.csv(url("https://d396qusza40orc.cloudfront.net/predmachlearn/pmltesting.csv"),header=TRUE) 
...
```
Since the Random Forests gave us a predicy=tion with the highest accuracy, we will go with model 2 for the final prediction.
